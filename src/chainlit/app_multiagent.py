...
async def on_chat_start():
    ...
    #await group_chat.add_chat_message(message=
       # f"Hello, I am {ORCHESTRATOR_NAME}. I will be your assistant today. Please provide customer ID to continue"
    #)
...
async def on_message(message: cl.Message):
    ...
    async for msg in group_chat.invoke():
        ...
        #answer.content = ">" +  msg.name + ": " + answer.content
        answer.author = msg.name
